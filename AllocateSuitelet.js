 ...
 */
define(['N/ui/serverWidget', 'N/record', 'N/redirect', 'N/url', 'N/search', 'N/format'], function (serverWidget, record, redirect, url, search, format) {
    ...
    function onRequest(context) {
        ...
        if (context.request.method === 'GET') {
            ...
            populateAssetOptions(typeParam, fromCustomerParam, fromSiteParam, assetField);
            ...
            messageField.defaultValue = '<h2>Asset allocation is being processed. Please wait...</h2>';
            ...
            if (type === 'warehouse') {
                ...
                for (var j = 0; j < assetIds.length; j++) {
                    ...
                    if (assettype) {
                        ...
                        log.error('No se encontrÃ³ informaciÃ³n para el cliente con ID:', toCustomerId);
                    }
                    ...
                    var lastDayOfMonth = new Date(allocationdate.getFullYear(), allocationdate.getMonth() + 1, 0);
                    ...
                    var usagePeriod = monthAbbreviation + ' ' + allocationdate.getFullYear();
    ...
    function populateAssetOptions(type, customerId, siteId, assetField) {
        ...
        } else if ((type === 'customer' || type === 'between') && customerId && siteId) {
    ...
    function parseDate(dateString) {
        ...
        for (var i = 0; i < formats.length; i++) {
            try {
                ...
                log.debug('Date Parsing', 'Failed to parse date: ' + dateString + ' with format: ' + formats[i]);
            }
        }
        return null;
    }
